...
export let mockCategories = [
  ...
  { id: 'cat-2', shop_id: 'shop-1', name: 'Fashion', description: 'Clothing and accessories', position: 2, parent_id: null, image_url: 'https://images.unsplash.com/photo-1445205170230-053b83016050?w=400&h=400&fit=crop' },
  { id: 'cat-3', shop_id: 'shop-1', name: 'Home & Garden', description: 'Home decor and plants', position: 3, parent_id: null, image_url: 'https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=400&fit=crop' },
  { id: 'cat-4', shop_id: 'shop-1', name: 'Kitchen', description: 'Kitchen tools and equipment', position: 4, parent_id: null, image_url: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=400&h=400&fit=crop' },
  { id: 'cat-5', shop_id: 'shop-1', name: 'Beauty & Health', description: 'Skincare, wellness and self-care', position: 5, parent_id: null, image_url: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?w=400&h=400&fit=crop' },
  { id: 'cat-6', shop_id: 'shop-1', name: 'Sports & Outdoors', description: 'Fitness gear and outdoor equipment', position: 6, parent_id: null, image_url: 'https://images.unsplash.com/photo-1624274362324-1b8342495edb?w=400&h=400&fit=crop' },
