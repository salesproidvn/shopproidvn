...
export const vi = {
  ...
  shopAddress: 'Địa chỉ',
  megaMenu: 'Mega Menu',
  megaMenuDesc: 'Chọn danh mục hiển thị trên thanh mega menu (chỉ hiển thị trên máy tính)',
  megaMenuSaved: 'Mega menu đã lưu',
  sortBy: 'Sắp xếp theo',
  maintenance: 'Bảo trì hệ thống',
  maintenanceDesc: 'Quét và dọn dẹp dữ liệu cũ trên hệ thống để tối ưu hóa hiệu suất.',
  scanSystem: 'Quét hệ thống',
  scanDesc: 'Quét toàn bộ hệ thống để tìm đơn hàng cũ hơn 1 năm và hình ảnh không được sử dụng.',
  startScan: 'Bắt đầu quét',
  scanning: 'Đang quét...',
  oldOrders: 'Đơn hàng cũ',
  year: 'năm',
  noOldOrders: 'Không có đơn hàng cũ hơn 1 năm',
  oldest: 'Cũ nhất',
  confirmDeleteOrders: 'Bạn có chắc muốn xóa các đơn hàng cũ? Hành động này không thể hoàn tác.',
  confirmDelete: 'Xác nhận xóa',
  deleteOldOrders: 'Xóa đơn hàng cũ',
  orphanedImages: 'Hình ảnh không sử dụng',
  noOrphanedImages: 'Không có hình ảnh không sử dụng',
  confirmDeleteImages: 'Bạn có chắc muốn xóa các hình ảnh? Hành động này không thể hoàn tác.',
  deleteOrphanedImages: 'Xóa hình ảnh',
  completedActions: 'Hoàn tất',
  rescan: 'Quét lại',
  facebook: 'Facebook',
  instagram: 'Instagram',
  ...
  maxWordsReached: 'Đã đạt giới hạn 1000 từ',
  maxWordsReachedProduct: 'Mô tả sản phẩm vượt quá 1000 từ',
  readMore: 'Đọc thêm',
  loadMore: 'Xem thêm',
  ...
  discountPercentage: 'Phần trăm (%)',
  discountFixed: 'Số tiền cố định (VND)',
  ...
  voucherInactive: 'Ngưng',
  noVouchers: 'Chưa có voucher nào',
  ...
  agentEmail: 'Email đại lý',
  agentPhone: 'Số điện thoại',
  agentLevel: 'Cấp đại lý',
  agentLevel1: 'Cấp 1 (Trưởng)',
  agentLevel2: 'Cấp 2 (Phó)',
  agentLevel3: 'Cấp 3',
  parentAgent: 'Lãnh đạo trực tiếp',
  noParentAgent: 'Không có (Cấp cao nhất)',
  trackingCode: 'Mã theo dõi',
  trackingLink: 'Link giới thiệu',
  totalSales: 'Tổng doanh số',
  orderCount: 'Số đơn hàng',
  agentActive: 'Đang hoạt động',
  noAgents: 'Chưa có đại lý nào',
  agentCreated: 'Đã tạo đại lý',
  agentUpdated: 'Đã cập nhật đại lý',
  agentDeleted: 'Đã xóa đại lý',
  confirmDeleteAgent: 'Bạn có chắc muốn xóa đại lý này?',
  maxAgentsReached: 'Đã đạt tối đa 100 đại lý',
  agentsFeature: 'Tính năng đại lý',
  agentsEnabled: 'Bật đại lý',
  agentsDisabled: 'Tắt đại lý',
  ownerSales: 'Doanh số Admin',
  agentSalesOverview: 'Tổng quan doanh số đại lý',
  myLeader: 'Lãnh đạo của tôi',
...
export const en = {
  ...
  shopAddress: 'Address',
  megaMenu: 'Mega Menu',
  megaMenuDesc: 'Choose which categories to display on the mega menu bar (desktop only)',
  megaMenuSaved: 'Mega menu saved',
  sortBy: 'Sort by',
  maintenance: 'System Maintenance',
  maintenanceDesc: 'Scan and clean up old data across the system to optimize performance.',
  scanSystem: 'Scan System',
  scanDesc: 'Scan the entire system to find orders older than 1 year and unused images.',
  startScan: 'Start Scan',
  scanning: 'Scanning...',
  oldOrders: 'Old Orders',
  year: 'year',
  noOldOrders: 'No orders older than 1 year',
  oldest: 'Oldest',
  confirmDeleteOrders: 'Are you sure you want to delete old orders? This action cannot be undone.',
  confirmDelete: 'Confirm Delete',
  deleteOldOrders: 'Delete Old Orders',
  orphanedImages: 'Unused Images',
  noOrphanedImages: 'No unused images found',
  confirmDeleteImages: 'Are you sure you want to delete unused images? This action cannot be undone.',
  deleteOrphanedImages: 'Delete Images',
  ...
  maxWordsReached: 'Maximum 1000 words reached',
  maxWordsReachedProduct: 'Product description exceeds 1000 words',
  readMore: 'Read More',
  loadMore: 'Load More',
  ...
  agentLevel1: 'Level 1 (Leader)',
  agentLevel2: 'Level 2 (Deputy)',
  agentLevel3: 'Level 3',
  parentAgent: 'Direct Leader',
  noParentAgent: 'None (Top Level)',
  trackingCode: 'Tracking Code',
  trackingLink: 'Referral Link',
  ...
  maxAgentsReached: 'Maximum 100 agents reached',
  agentsFeature: 'Agent Feature',
  agentsEnabled: 'Agents Enabled',
  agentsDisabled: 'Agents Disabled',
  ownerSales: 'Owner Sales',
  agentSalesOverview: 'Agent Sales Overview',
  myLeader: 'My Leader',
